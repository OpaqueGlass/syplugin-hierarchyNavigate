 ...
 * @returns 
 */
export function isNotebookDocEnabled(): boolean {
 ...
 * @returns 
 */
export function isNotebookDoc(path: string, notebookId: string): boolean {
 ...
 * @returns 
 */
export function getListDocsByPathAPIFilePath(fullPath: string, notebookId: string): string {
    if (fullPath == null) {
        return null;
    }
