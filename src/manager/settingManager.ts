...
export function initSettingProperty() {
    tabProperties.push(
        new TabProperty({key: "content", props:[
            ...
            new ConfigProperty({"key": "enableSiblingArea", "type": "SELECT", "options": 3}),
            ...
            new ConfigProperty({"key": "showBackLinksArea", "type": "SELECT", "options": 3}),
        ]}),
        new TabProperty({key: "general", props: [
            new ConfigProperty({"key": "fontSize", "type": "NUMBER"}),
            new ConfigProperty({"key": "popupWindow", "type": "SELECT", options: 3}),
