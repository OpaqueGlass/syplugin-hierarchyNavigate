...
> 当前版本：v1.11.2
>
> - 修复：插件显示和插入挂件时，iframe src未按照规范`/`结尾导致不能显示的问题；
>
> 【若使用快捷键插入“列出子文档”挂件，请升级至此版本，**备份数据后**运行一次数据订正（请前往 层级导航插件 - 设置 - 试验田 - 修正 listChildDocs 挂件 src。）】
> 
...
| 功能 | 默认快捷键 | 快捷键设置参考| 备注 |
| --- | --- | --- | --- |
| 跳转到父文档（向上） | `⌥⌘←` 或 `Ctrl + Alt + ←` | | 默认快捷键可能和网易云音乐全局快捷键冲突，以下3个快捷键也有相同的问题 |
